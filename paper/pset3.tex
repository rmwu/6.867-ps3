...
which is intuitively similar to a multi-dimensional sigmoid.  % TODO is this necessary?
...
We compared our neural network's performance to that of a
kernelized Gaussian RBF SVM classifier and 
observed comparable performance in accuracy.
We used optimal parameters for both, 
with two 5-node hidden layers for the neural network.
