...
% TODO plug my computer in so I can actually run these
...
%[20, 20]
%Ran for 200001 iterations.
%Guessed 1843 correct out of 2000 (0.9215)
%Average loss 0.537023668884212

%[100]
%Ran for 152500 iterations.
%Guessed 1889 correct out of 2000 (0.9445)
%Average loss 0.43865500872982616

%[100, 100]
%Ran for 104500 iterations.
%Guessed 1901 correct out of 2000 (0.9505)
%Average loss 0.3172982679689496

% % % % % % % % % %
%    PROBLEM 2
% % % % % % % % % %

In addition to $k$-class classification of individual digits, we also
used our neural network for binary classification of digit pairs,
to compare with other classification methods.
